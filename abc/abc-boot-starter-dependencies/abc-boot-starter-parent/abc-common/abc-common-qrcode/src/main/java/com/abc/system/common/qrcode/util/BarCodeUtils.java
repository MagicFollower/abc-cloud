...
public class BarCodeUtils {
     ...
     */
    public static String generateCode(String content, int width, int height) throws ValidateException {
        //定义位图矩阵BitMatrix
        ...
        try {
            ...
            throw new ValidateException(SystemRetCodeConstants.SYSTEM_BUSINESS.getMessage(), "条形码生成失败，请稍候重试");
        } finally {
